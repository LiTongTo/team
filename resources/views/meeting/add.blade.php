...
<center><h3>拜访会议</h3></center><hr>
<form action="{{url('/meeting/store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id='fm'>
@csrf
		...
		<div class="col-sm-7">
          <select name="sale_id" id="sale_id">
          	<option value="0">请选择业务员</option>
     	      @foreach($ywy as $c)
            <option value="{{$c->sale_id}}">{{$c->sale_name}}</option>
            @endforeach
          </select>		   
...
<!-- 	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
         <input type="text" class="form-control" id="lastname" name='meeting_man'placeholder="访问人"> 		    
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
<input type="text" class="form-control" id="lastname" name='meeting_address'placeholder="访问地址">          
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
         <input type="text" class="form-control" id="lastname" name='meeting_time'placeholder="下次访问时间">          
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default">添加信息</button>
		</div>
	</div>
</form>
